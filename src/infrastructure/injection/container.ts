...
import { bookingsModule } from "./booking.module.container";
import { receptionistModule } from "./receptionist.module.container";
...
container.load(receptionistModule);

container.load(bookingsModule);
